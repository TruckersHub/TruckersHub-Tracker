...
class JsonDB {
  ...
  set(db, data) {
    ...
    var content = "{}"
    try {
      content = JSON.parse(fs.readFileSync(`${this.dbFolder}/${this.dbName}.json`, "utf8"));
      fs.writeFileSync(`${this.dbFolder}/${this.dbName}.bak.json`, JSON.stringify(content))
    } catch (error) {
      console.log(error)
      // fs.rmSync(`${this.dbFolder}/${this.dbName}.json`)
      // fs.copyFileSync(`${this.dbFolder}/${this.dbName}.bak.json`, `${this.dbFolder}/${this.dbName}.json`)
      // content = JSON.parse(fs.readFileSync(`${this.dbFolder}/${this.dbName}.json`, "utf8"));
    }
  ...
  get(db) {
    ...
    try {
      ...
      if (String(error).startsWith("SyntaxError")) {
        fs.writeFileSync(`${this.dbFolder}/${this.dbName}.json`, "{}");
      }
      console.log(error)
      // fs.rmSync(`${this.dbFolder}/${this.dbName}.json`)
      // fs.copyFileSync(`${this.dbFolder}/${this.dbName}.bak.json`, `${this.dbFolder}/${this.dbName}.json`)
