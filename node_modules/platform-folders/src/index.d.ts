...
export declare function getStateFolder(): string;
export declare function getConfigHome(): string;
export declare function getDataHome(): string;
export declare function getDataFolders(): string[];
export declare function getConfigFolders(): string[];
 ...
 */
declare type Folder = "home" | "appData" | "appdata" | "userData" | "desktop" | "documents" | "downloads" | "music" | "pictures" | "videos" | "cache" | "savegames" | "state";
